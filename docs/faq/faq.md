...
![Message de confirmation](registration_confirmation.png)
...
![page de connexion](connection.png)
1. Cliquer sur `Se connecter`
...
![création article](article_new.png)
